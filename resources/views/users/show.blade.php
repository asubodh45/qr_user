<x-app-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 bg-white rounded-2xl shadow p-6 text-center">
            ...
            @else
                <div class="w-28 h-28 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-4xl mx-auto mb-4">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($profile->images->isNotEmpty())
                <div class="bg-white rounded-2xl shadow p-6">
                    <h3 class="text-base font-semibold text-gray-700 mb-4">Photos ({{ $profile->images->count() }})</h3>
                    <div class="grid grid-cols-3 sm:grid-cols-4 gap-3">
                        @foreach($profile->images as $image)
                            <div class="relative">
                                ...
                                @if($image->is_profile)
                                    <span class="absolute top-1 left-1 bg-indigo-600 text-white text-[9px] font-bold px-1.5 py-0.5 rounded">
                                        Profile
                                    </span>
                                @endif
                            </div>
